...
bobmods.lib.tech.add_recipe_unlock("rubbers", "bob-insulated-cable")

-- Circuit network wires should not require rubber
--bobmods.lib.recipe.set_ingredients("green-wire", { { "solid-paper", 2 }, { "bob-tinned-copper-cable", 1 } })
--bobmods.lib.recipe.set_ingredients("red-wire", { { "solid-paper", 2 }, { "bob-tinned-copper-cable", 1 } })

if mods["CircuitProcessing"] then
  bobmods.lib.tech.add_prerequisite("efficiency-module", "rubbers")
